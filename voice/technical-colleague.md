...
- A figure gets enough room to be read, its text is legible at the size shown, and a figure with many panels is laid out as a grid over several rows rather than squeezed into one strip.
