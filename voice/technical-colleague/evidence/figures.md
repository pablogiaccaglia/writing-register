...
Rules: figures.show-outputs, figures.requested-view, figures.representative-examples, figures.beside-truth, figures.before-after, figures.didactic, figures.says-how-made, figures.consistent-panels, figures.labels, figures.layout, figures.beside-published, figures.inside-each-part, figures.field-conventions, figures.working-example
