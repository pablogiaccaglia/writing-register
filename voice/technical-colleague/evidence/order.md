...
Rules: order.point-first, order.straight-line, order.paragraph-opens, order.join-by-reason, order.one-subject, order.lists, order.announced-follows, order.steps, order.headings
